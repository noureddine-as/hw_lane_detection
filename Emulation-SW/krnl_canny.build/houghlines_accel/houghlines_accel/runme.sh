...
HD_PWD='/home/centos/labs/lane_detector_v2/Emulation-SW/krnl_canny.build/houghlines_accel/houghlines_accel'
cd "$HD_PWD"
...
EAStep vitis_hls -f houghlines_accel.tcl -messageDb vitis_hls.pb
